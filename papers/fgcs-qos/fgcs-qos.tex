...
model that eases the interoperability, integration and monitoring of 
...
services. A semantic-based framework is also outlined taking into account the 
...
% To-do
% 3-Explain in detail lambda architecture
% 4-Fix references and include reviewer ones, prism project, mosaic, etc.
% 5-Conclusions
% 6-Reponse to reviewers
% 7-Proofreading
