...
querying, among others. As authors present ie~\cite{deri2010}] traditional data stream 
...
\item The use of the R statistics package [90] is widely accepted in the Big 
Data community to make decisions, 
predictions or analysis and perform statistical methods on large datasets. In 
